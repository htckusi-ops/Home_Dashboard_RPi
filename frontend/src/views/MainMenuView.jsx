...
export default function MainMenuView() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      {/* Right column: calendar widget (only if calendars are configured) */}
      {hasCalendars && (
        <div className="w-64 shrink-0 border-l border-gray-700 flex flex-col p-3 overflow-hidden">
          <p className="text-xs text-gray-500 uppercase tracking-wide mb-2 px-1 shrink-0">
            Heute
          </p>
